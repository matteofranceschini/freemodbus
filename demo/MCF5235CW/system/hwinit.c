...
void mcf523x_init(void)
{
    ...
    mcf5xxx_wr_cacr(0 | MCF5XXX_CACR_CENB | MCF5XXX_CACR_CINV | MCF5XXX_CACR_DISD | MCF5XXX_CACR_CEIB | MCF5XXX_CACR_CLNF_00);
...
void mcf523x_gpio_init(void)
{
     ...
     */
    MCF_GPIO_PAR_AD = (0 | MCF_GPIO_PAR_AD_PAR_ADDR23 | MCF_GPIO_PAR_AD_PAR_ADDR22 | MCF_GPIO_PAR_AD_PAR_ADDR21 | MCF_GPIO_PAR_AD_PAR_DATAL);
