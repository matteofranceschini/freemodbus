...
* Description    : This routine is used to configure the XTI Mode.
...
* Description    : This routine is used to get the interrupt lines status.
* Input 1        : None.
...
* Description    : This routine is used to clear the pending bits.
