...
err_t sio_open_low_level(u8_t devnr, serdev_t *dev)
{
    err_t error = ERR_OK;
...
err_t sio_close_low_level(u8_t devnr, serdev_t *dev)
{
    err_t error = ERR_OK;
...
void sio_serial_isr(UART_TypeDef *UARTx, u8_t *need_ctx_switch)
{
    int i;
    u16 status;
